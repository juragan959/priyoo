...
echo "\e[96m______________________________________________________\n";
echo "\e[96m______________________________________________________\n";
echo color("yellow" ," **************** SCRIPT GOPUT **************** \n");
echo color("yellow"," **************** BY : PRIYO ***************** \n");

echo color("yellow"," **************** SPECIAL  PSBB **************** \n");
...
function change(){
        ...
        $expired6 = getStr1('"expiry_date":"','"',$cekvoucher,'6');
         ...
         echo color("red","NOMER LU UDAH KEDAFTAR /SALAH !!!");
         echo "\nMau ulang? (y/n): ";
