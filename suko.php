...
echo "\e[95m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo "\e[96m_________  Bismillahirrahmanirrahim __________ \n";
echo "\e[96m                                                        \n";
echo "\e[96m          KITA TIDAK HARUS BERPIKIR SAMA               \n";
echo "\e[96m                        TAPI                           \n";
echo "\e[96m            MARI KITA SAMA-SAMA BERPIKIR              \n";
echo "\e[96m                                                        \n";
echo "\e[96m             * REPACK BY  : @CAKPRIYO *                  \n";
...
else
{
		...
		echo "\e[96m[🚫]           \e[91mMASIH AJA NGEYEL LU      \e[96m [🚫]\n";
	        echo "\e[96m[🚫] \e[91mBELOM PERNAH DICIPOK CAK MET YA LO \e[96m [🚫]\n";
		echo "\e[91m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
goto login;
}
	return rtrim( $input, "\n" );
...
// function change(){
        ...
        echo "\n".color("yellow","# SABAR YA , DIKIT LAGI KOK BIAR KELUAR");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(5);
        }
